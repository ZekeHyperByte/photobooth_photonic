/**
 * Browser-safe configuration constants
 * These can be safely imported in frontend code without Node.js dependencies
 */
...
export const APP_CONFIG = {
  ...
  // Capture settings
  CAPTURE_WARMUP_SECONDS: 4,
  CAPTURE_COUNTDOWN_SECONDS: 5,
  CAPTURE_RESULT_DISPLAY_SECONDS: 4,
  CAPTURE_HIDDEN_COUNTDOWN: 0,
...
// Re-export paper-sizes (they are safe for browser)
export {
  PAPER_SIZE_CONFIGS,
  DEFAULT_TOLERANCE,
  detectPaperSize,
